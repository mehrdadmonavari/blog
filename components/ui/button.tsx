  ...
  "focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        selectInput: "flex h-10 w-full items-center justify-start rounded-md border border-input focus-visible:outline-none px-3 py-2 text-sm disabled:cursor-not-allowed disabled:opacity-50",
        none: ""
      },
      size: {
        default: "",
